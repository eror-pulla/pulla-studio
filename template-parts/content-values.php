                ...
                while( have_rows('values') ): the_row(); 
                    if( have_rows('values_repeater') ): 
                        ...
                        while( have_rows('values_repeater') ): the_row(); 
                            ...
                            $img_alt = get_sub_field('img_alt'); // Fetch alt text field if exists

                            // Construct each section and store in array
                            $sections[] = '<div class="section-' . $counter . '" data-section-id="' . $counter . '" data-scroll>
